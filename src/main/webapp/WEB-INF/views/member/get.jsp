	...
	<div class="container">
		...
		<div class="row justify-content-center">
			<div class="col-12 col-lg-6">
				...
				<input class="form-control" type="datetime-local" value="${member.inserted }" readonly /> <br />
				</div>
				...
				<button class="btnbtn-danger" data-bs-toggle="modal" data-bs-target="#modal1">삭제</button>
				</div>
	</div>
	</div>
	</div>
