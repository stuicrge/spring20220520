		...
		$(document).ready(function() {
			...
			$("#button19").click(function(){
				$.ajax({
					...
					error : function(){
						$("#message19").show();
						$("#message19").text("처리중 오류발생").fadeOut(3000);
					}
				});
			});
...
<body>
	...
	<button id="button2">ajax 요청 보내기</button><br />
	...
	<button id="button10">post방식으로 데이터 보내기 (encoded)</button> <br />
	...
	<br />
	<button id="button15">로또번호받기</button>
